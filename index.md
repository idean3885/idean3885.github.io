...
- [claude-devex](https://github.com/idean3885/claude-devex) - 이슈 플로우·콘텐츠 작성·교차 검증을 묶은 개인 개발 어시스턴트. 작성 원칙과 워크플로우 규칙을 하네스(SessionStart·hook·스킬)에 주입해 매 세션 같은 출발선에서 동작
- [trip-planner](https://github.com/idean3885/trip-planner) - spec-kit 풀사이클과 하네스로 만든 1인 풀스택 프로젝트. MCP 20종과 RapidAPI(유료) 연동으로 자연어 숙소·항공·활동 검색을 일정에 자동 반영
