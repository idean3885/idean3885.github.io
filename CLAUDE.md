...
| [claude-cross-verify](https://github.com/idean3885/claude-cross-verify) | [교차 검증 도구 3개월: 사상·구현·운영과 스스로 찾은 맹점](https://blog.idean.me/posts/cross-verify-tool-3month/) | 4축 검증 프레임워크, 프로필 시스템 (cross-verify.json), 프롬프트-only 구조, 4축 보안 질문 추가 + OWASP 분류 기준 |
