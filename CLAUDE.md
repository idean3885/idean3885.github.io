...
| [claude-slack-to-notion](https://github.com/dykim-base-project/claude-slack-to-notion) | [건네도 될까에서 건넸다로 — 비개발자 실전 피드백](https://idean3885.github.io/posts/real-feedback-from-non-developer/) | 토큰 발급 가이드 구조, check_active_users, 비개발자 설정 UX |
