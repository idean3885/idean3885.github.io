...
> **TL;DR** 비개발자 E2E를 기획하다가 설치 경로 자체가 없다는 걸 발견했습니다.
> 테스트가 버그 수정이 아니라
> 배포 아키텍처 전환(6단계→2단계)의 계기가 됐습니다.
{: .prompt-tip }
...
[uvx 사용법 안내서](https://idean3885.github.io/posts/uvx-guide-for-java-developers/)에 정리했습니다.
