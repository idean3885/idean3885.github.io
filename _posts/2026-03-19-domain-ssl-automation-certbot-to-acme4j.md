...
last_modified_at: 2026-04-02 02:20:00 +0900
...
description: >-
  ...
  certbot으로 ACME 프로토콜을 학습하고, ACME4j로 Java BE에 통합한 8주간의 과정을 공유합니다.
---

> **TL;DR**
> - 앱 배포 플랫폼에 사용자 도메인 연결 기능이 추가되면서, 개별 도메인마다 SSL 인증서를 자동 발급해야 하는 과제가 생겼습니다.
> - certbot으로 Let's Encrypt의 ACME 프로토콜을 먼저 학습한 뒤, HTTP-01 Challenge 기반으로 ACME4j 라이브러리를 Java BE에 통합했습니다.
> - 상태 머신으로 인증서 생명주기를 관리하고, 배치 Job으로 발급·갱신·재시도·타임아웃을 처리하는 구조를 설계했습니다.
