...
> **TL;DR**<br>
> 이슈 사이클로 첫 도구(Slack→Notion 플러그인)를 만들었습니다.<br>
> 명세를 먼저 쓰니 구현이 빨랐고,
> 이슈 단위로 나누니 되돌리기가 쉬웠습니다.
{: .prompt-tip }
...
> 어디까지 만들지가 명확하니, AI에게 정확한 지시를 줄 수 있었습니다.<br>
...
> 이후 비개발자 피드백을 거치며 이 판단은 뒤집혔습니다.<br>
> Bot 토큰은 채널 초대와 권한 설정이 추가로 필요해
> 비개발자에게는 사용자 토큰이 더 간단했습니다.
> 현재는 사용자 토큰을 권장하고, Bot 토큰은 팀 공유용 옵션입니다.
{: .prompt-info }
